...
cp /root/ci5cat/extras/dns_failover.sh /etc/ci5-dns-failover.sh
cp /root/ci5cat/extras/dns_failover.init /etc/init.d/ci5-dns-failover
...
cp /root/ci5cat/extras/pppoe_noqdisc.hotplug /etc/hotplug.d/iface/99-pppoe-noqdisc
...
cp /root/ci5cat/extras/paranoia_watchdog.sh /root/scripts/
